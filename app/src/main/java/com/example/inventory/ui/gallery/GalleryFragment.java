...
public class GalleryFragment extends Fragment {
    ...
    private TextInputLayout name, description, count, bought, sell;
    ...
    private String name1, description1, count1, bought1, sell1;
...
//                    DocumentReference documentReference = fStore.collection("Items").document(UID);
//                    documentReference.update("id", uri[0]);
...
//        System.out.println(uri[0]+" @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
    ...
    // UploadImage method
    private String uploadImage(String dataId)
    {
            StorageReference ref
                    = storageReference
                    .child(
